...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    ...
    <body>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <nav class="">
                <ul class="px-3 nav dark:bg-gray-800">
            ...
            <h5 class="home-title">Choose or create a new to do list</h5>
        <div class="card dark:bg-gray-800 p-3">
            <div class="card w-50">
                <div class="card-body">
            ...
            <div class="mt-3 text-end">
                <button class="btn btn-primary" type="button">Create a new To Do List</button>
            </div>
        </div>
